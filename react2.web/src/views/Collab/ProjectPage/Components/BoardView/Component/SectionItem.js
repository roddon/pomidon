...
import {Add,AddOutlined, ArrowDropDown, ArrowDropUp, MoreHoriz} from '@material-ui/icons';
    ...
    (
      <div style = {{ marginRight : 20, width: 300, height : '70px'}}>
              <div style = {{display : 'flex', alignItems : 'center'}}>
                {
                loading == true ? 
                <span style = {{fontSize : '16px', fontWeight : 'bold'}}>{section_name}</span> 
                :
                <InlineInputEdit 
                  text= {section_name}
              ...
              <MenuButton btn_style = 'section' onEdit = {onEditSection} onDel = {onDeleteSection}/>
          </div>
          <Button 
              style = {{width : '100%', marginTop : 5, marginBottom : 8}}
              variant = "outlined" size = "small" onClick = {() => onAdd(section)} >
